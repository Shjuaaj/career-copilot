...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // On success, redirect them to the sign-in page to log in!
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-xl shadow-md border border-gray-100">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Join career-copilot to start optimizing your resume
          </p>
        </div>
        ...
        <div className="text-center mt-4">
          <Link href="/auth/signin" className="font-medium text-blue-600 hover:text-blue-500 text-sm transition">
